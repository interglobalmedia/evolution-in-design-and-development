...
```
<a href="https://github.com/interglobalmedia/react-todo-app/blob/master/style/App.css" fontWeight="bold" textColor="rebeccapurple" target="_blank">Full Example</a>
