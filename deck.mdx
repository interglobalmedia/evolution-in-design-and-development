...
<a href="https://github.com/interglobalmedia/restaurant-project-2/blob/master/app/assets/styles/styles.css">Full Example</a>
...
<a href="https://github.com/interglobalmedia/portfolio/blob/master/src/components/Skills/Skills.js" target="_blank">Skills.js</a><br />
<a href="https://github.com/interglobalmedia/portfolio/blob/master/src/styles/partials/_skills.scss" target="_blank">_skills.scss</a><br />
...
First `git clone` or download the zip of the <a href="https://github.com/interglobalmedia/evolution-presentation-cra-1-2019" target="_blank">evolution-presentation-cra</a> `repo`.

---

After you have `npm install`ed, you can get immediately cracking with <b>CSS Modules</b>.

---

Create a <b>new branch</b> called `css-modules` and checkout into it. Simply run the command `git checkout -b css-modules`.

---

In <b>CRA</b> `< 2.0`, we had to `eject` out of <b>CRA</b> in order to `enable` <b>CSS Modules</b>. with <b>CRA</b> `>= 2.0`, <b>CSS Modules</b> (and Sass) is `supported` <b>out of the box</b>.

---

<b>First</b> you want to `import` your `classes` from the <b>stylesheet</b> corresponding to the `component` you are styling.
